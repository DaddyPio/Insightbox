...
export const translations: Record<AppLanguage, Translations> = {
  ...
  'en': {
    ...
    step3Text: 'Go to "Cards" to view, organize, then use Daily Inspiration/Long-form Writing',
    aiWillGenerate: 'After saving, AI will automatically generate:',
    aiWillGenerateTitle: 'Title',
    aiWillGenerateTags: 'Tags',
    aiWillGenerateEmotion: 'Emotion',
    aiWillGenerateSummary: 'Summary',
    recordingHint: 'Recording... Click again when finished',
    transcriptionComplete: '🎧 Transcribed from voice, you can edit before saving.',
    noCardsYet: 'No cards yet.',
    noCardsHint: '👉 Go to "Home" to enter a thought or record audio, InsightBox will automatically create your first card.',
    goToHome: 'Go to Home',
    createDescription: 'Combine your notes into 500–1000 word articles, perfect for FB, IG posts, or blog.',
    quickStart: 'First time? No need to read everything',
    quickStartDescription: 'Learn these three features to get started:',
    quickStartStep1: 'Home: Quick text/voice capture',
    quickStartStep2: 'Cards: View and organize cards',
    quickStartStep3: 'Daily Inspiration: See AI-generated daily messages',
    goToPage: 'Go to',
  },
  'ja': {
